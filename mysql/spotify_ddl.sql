...
CREATE TABLE IF NOT EXISTS 53bdt_db.spotify_rock_playlists_data(
    ...
    tempo decimal(20,10),  
    music_id PRIMARY KEY varchar(40), 
    uri  varchar(40),    
...
LOAD DATA INFILE 'archive/rock_music_data.csv'
...
LOAD DATA INFILE 'archive/pop_music_data.csv'
...
LOAD DATA INFILE 'archive/metal_music_data.csv'
...
LOAD DATA INFILE 'archive/indie_alt_music_data.csv'
...
LOAD DATA INFILE 'archive/hiphop_music_data.csv'
...
LOAD DATA INFILE 'archive/blues_music_data.csv'
...
LOAD DATA INFILE 'archive/alternative_music_data.csv'
